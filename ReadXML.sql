...
BEGIN
	...
	/*INSERT INTO dbo.CuentaAhorro(IdPersona, TipoCuentaId, NumeroCuenta, FechaCreacion, Saldo)
		VALUES (@Ididen, @tipoC, @numC, @fecha, @saldo)*/
	-- Quitar comentarios para añadir todas las cuentas aun que no tengan persona asociada (poner en comentario la instruccion anterior)
...
BEGIN
	...
	/*INSERT INTO dbo.Beneficiario(IdCuenta, IdPersona, ParentezcoId, Porcentaje)
						VALUES(@IdCuenta, @Ididen, @parentezco, @porcentaje)*/
	-- Quitar comentarios para añadir todos los beneficiarios aunque la persona y/o la cuenta no este en la BD (poner en comentario la instruccion anterior)
...
BEGIN
	...
	/*INSERT INTO dbo.Usuario([User], Pass, IdPersona, EsAdministrador) VALUES(@user, @pass, @Ididen, @admin)*/
		-- Quitar comentarios para añadir todos los usuarios aun que no exista la persona (poner en comentario la instruccion anterior)
